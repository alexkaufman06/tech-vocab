techVocab.factory("AppFactory", function AppFactory($firebaseArray, $state) {
  ...
  factory.decks = [
    ...
    { name:"JavaScript", id:2, cardCounter: 11,
        cards: [
          {front: "parseFloat()",
            back: "Parses a string and returns a floating point number", id:1 },
          {front: "parseInt()",
            back: "Parses a string and returns an integer", id:2 },
          {front: "toExponential()",
            back: "Converts a number to exponential notation", id:3 },
          {front: "concat()",
            back: "Combines the text of two or more strings and returns a new string", id:4 },
          {front: "alert()",
            back: "Opens a dialog box and returns undefined", id:5 },
          {front: "confirm()",
            back: "Opens a dialog box and returns a boolean", id:6 },
          {front: "prompt()",
            back: "Opens a dialog box and returns a string", id:7 },
          {front: "charAt()",
            back: "Returns the specified character from a string", id:8 },
          {front: "join()",
            back: "Joins all elements of an array into a string", id:9 },
          {front: "pop()",
            back: "Removes the last element from an array and returns that element", id:10 }
        ]
      },
      ...
      { name:"Non-technical Interview Questions", id:4,
          cards: [
            {front: "Why did you get into programming?",
              back: "Try and give a short overview, segway into a problem, and then give a solution!", id:1 },
            {front: "What made you pick Epicodus?",
              back: "Overview, problem, solution.", id:2 },
            {front: "Where do you see yourself in the future?",
              back: "Try and relate your future to your job.", id:3 },
            {front: "Tell me about yourself.  What's your background?",
              back: "Do your best to relate your background to your job of interest.", id:4 },
            {front: "What problems do you see with current web development tools?",
              back: "Overview. Problem. Solution", id:5 },
            {front: "What do you like about current web development trends?",
              back: "Relate to trends your job of interest uses", id:6 },
            {front: "Do you write JavaScript or rely more on libraries like jQuery?",
              back: "Try and show how you are capable of both?", id:7 },
            {front: "What frameworks have you used?",
              back: "Ember, Angular...", id:8 },
            {front: "What testing tools have you used?",
              back: "Rspec, Mocha", id:9 },
            {front: "Are you familiar with HAML/SASS/Markdown?",
              back: "HAML- lightweight markup language SASS- a CSS extension Markdown- text to HTML conversion tool", id:10 },
            {front: "Why do you want to work here?",
              back: "Overview. Problem. Solution.", id:11 },
            {front: "What questions do you have for me?",
              back: "Ask about their practices, tools and culture - have three or so questions ready for them.", id:12 },
            {front: "What kind of culture do you want in your workspace?",
              back: "Try and link this to what you know about their culture and what you want.", id:13 },
            {front: "What are some of the challenges you faced while pairing?",
              back: "Overview. Problem. Solution.", id:14 },
            {front: "Give an example of how you resolved a disagreement with your pair.",
              back: "Overview. Problem. Soltuion.", id:15 },
