    ...
    { name:"English Vocab", id:6, cardCounter: 21,
      cards: [
        { front: "Quintessence",
          ...
          id:1, order: 1 },
        { front: "Cantankerous",
          back: "Having a difficult and contrary disposition.  Stubbornly obstrucive and unwilling to cooperate.", id:2, order: 2 },
        { front: "Aphorism",
          back: "A short and concise instructive saying.", id:3, order: 3 },
        { front: "Incubation",
          back: "Sitting on eggs so as to hatch them by the warmth of the body.", id: 3, order: 3 },
        { front: "Trepidation",
          back: "A feeling of alarm or dread.", id: 4, order: 4 },
        { front: "Pedantic",
          back: "Marked by a narrow focus on or display of learning especially its trivial aspects.", id: 5, order: 5 },
        { front: "Loquacious",
          back: "Full of trivial conversation", id: 6, order: 6 },
        { front: "Odiferous",
          back: "Having a natural fragrance. Emmiting an odor.  Morally offensive.", id: 7, order: 7 },
        { front: "Menagerie",
          back: "A collection of live animals for study or display.", id: 8, order: 8 },
        { front: "Posterity",
          back: "All future generations.", id: 9, order: 9 },
        { front: "Filibuster",
          back: "Obstructing legislation deliberatley by delaying.", id: 10, order: 10 },
        { front: "Tintinnabulation",
          back: "The sound of a bell ringing", id: 11, order: 11 },
        { front: "Preordained",
          back: "Foreordain or determine beforehand.", id: 12, order: 12 },
        { front: "Proverbial",
          back: "Widely known and spoken of.", id: 13, order: 13 },
        { front: "Insidious",
          back: "Working or spreading in a hidden and usually injurious way.", id: 14, order: 14 },
        { front: "Depravity",
          back: "A corrupt or depraved or degenerate act or practice.  Moral perversion.", id: 15, order: 15 },
        { front: "Lascivious",
          back: "Driven by lust", id: 16, order: 16 },
        { front: "Decadent",
          back: "Marked by excessive self-indulgence and moral decay.", id: 17, order: 17 },
        { front: "Precocious",
          back: "Appearing or developing early. (especially in mental aptitude)", id: 18, order: 18 },
        { front: "Egregious",
          back: "Conspicuously and outrageiously bad or reprehensible", id: 19 , order: 19},
        { front: "Androgynous",
          back: "Having both male and female characteristics but with a female apperance.", id: 20 , order: 20}
      ]
    }
  ];
